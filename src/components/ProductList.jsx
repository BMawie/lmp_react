...
function ProductItem(props) {
    ...
    props.products.forEach((item,idx) => {
        if (item.name != null) {
            ...
            if ((idx)%3===2) {columns.push(<div className="w-100"></div>)}
        }
        else {
            columns.push(
                <div className="col-sm py-3" key={item.id.toString()}>
...
const ProductList = ({ website }) => {
    const [products, setProducts] = useState([
        {   name: "Longchamp Amazone Besace xs bordeaux",
            ...
            sale: "245",
            brand: "Longchamp",
            src: "https://lamalleposte-alencon.fr/wp-content/uploads/2018/11/amazone_python-600x655.jpg",
        ...
        {   name: "Mademoiselle Longchamp grenat",
            ...
            sale: "623",
            brand: "Longchamp",
            src: "https://lamalleposte-alencon.fr/wp-content/uploads/2019/09/MADEMOISELLE-LONGCHAMP-grenat-600x600.png",
        ...
        {   name: "Longchamp sac seau Paris Rock Velours",
            ...
            sale: "180",
            brand: "Longchamp",
            src: "https://lamalleposte-alencon.fr/wp-content/uploads/2019/09/paris_rock_velours_seau-600x655.jpg",
            details: "Sac à rabat porté épaule XS – Longchamp\nCorps : Cuir de veau brillant façon python",
            delivery: "Frais de livraison: 10€ en suivi\nVeuillez appeler la boutique si vous souhaitez vous faire livrer.",
            hasFacebook: true,
            facebookUrl: "https://www.facebook.com/La-Malle-Poste-121712695175783/",
        ...
        {   name: "Mademoiselle Longchamp besace pilote",
            ...
            sale: "890",
            brand: "Longchamp",
            src: "https://lamalleposte-alencon.fr/wp-content/uploads/2018/11/mademoiselle_pilote-600x655.jpg",
            details: "Sac à rabat porté épaule XS – Longchamp\nCorps : Cuir de veau brillant façon python",
            delivery: "Frais de livraison: 10€ en suivi\nVeuillez appeler la boutique si vous souhaitez vous faire livrer.",
            hasFacebook: true,
            facebookUrl: "https://www.facebook.com/La-Malle-Poste-121712695175783/",
